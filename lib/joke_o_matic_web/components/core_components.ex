defmodule JokeOMaticWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JokeOMaticWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JokeOMaticWeb.Gettext, "errors", msg, opts)
    end
  end
